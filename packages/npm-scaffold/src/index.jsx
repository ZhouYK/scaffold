...
class ImgToCanvas extends Component {
  ...
  render() {
    ...
    return (
      <section className="img-to-canvas-wrap">
        <canvas className={className} ref={this.canvasRef} style={ style } width={ width } height={ height } ></canvas>
      </section>
    )
  }
}
